...
<head>
    ...
    <style>
        body { background: linear-gradient(rgba(6, 30, 63, 0.85), rgba(6, 30, 63, 0.85)), url('bglautmermaid.jpeg'); color: white; font-family: 'Inter', sans-serif; padding: 120px 40px 40px; }
